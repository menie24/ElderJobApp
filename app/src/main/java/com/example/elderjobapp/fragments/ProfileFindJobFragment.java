...
import com.example.elderjobapp.LogoMainActivity;
...
public class ProfileFindJobFragment extends Fragment {
    ...
    public ProfileFindJobFragment() {
        // Required empty public constructor
    }
    public static ProfileFindJobFragment newInstance() {
        ProfileFindJobFragment fragment = new ProfileFindJobFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_profile_find_job, container, false);
        ...
        editProfileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditProfileFindJobFragment editProfileFindJobFragment = EditProfileFindJobFragment.newInstance(user);
                FragmentTransaction transaction = getParentFragmentManager().beginTransaction();
                transaction.replace(R.id.frame_layout, editProfileFindJobFragment);
